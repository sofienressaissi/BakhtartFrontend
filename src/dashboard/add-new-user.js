...
export default function AddNewUser() {
    ...
    const addUser = async (event) => {
        ...
        try {
            ...
            var templateParams = {
                email: email,
                subject: "Welcome To BakhtArt",
                content: `We added you to BakhtArt. Login to your account:
    ...
    emailjs.send('gmail', 'template_o16x6cr', templateParams, 'user_aA9P4JZixsituJGeWQYWC')
        .then((result) => {
            ...
            console.log(error.text);
              ...
              setDisAddBtn(true);
              setTimeout(function(){
                  toast.show({title: 'Email Sent! Redirecting!',
            position: 'topright', type: 'info'});
...
<head>
    <title>BakhtArt - Add New User</title>
                          ...
                          <ul className="pcoded-item pcoded-left-item">
                              ...
                              <li className="pcoded-hasmenu">
                                  <a href="/admin/add-new-user" className="waves-effect waves-dark">
                                      ...
                                      <span className="pcoded-mtext"  data-i18n="nav.basic-components.main"><b>Add New User</b></span>
                                      <span className="pcoded-mcaret"></span>
                                  </a>
                              </li>
                          </ul>
                              ...
                              <div className="row align-items-center">
                                  <div className="col-md-8">
                                      <div className="page-header-title">
                                          ...
                                          <p className="m-b-0">Add New User</p>
                                      </div>
                                  </div>
                                  <div className="col-md-4">
                                      <ul className="breadcrumb-title">
                                          ...
                                          <li className="breadcrumb-item"><a>Add New User</a>
                                          </li>
                                      </ul>
                                  </div>
...
transition: all 0.3s;\
                    ...
                    <div className="card">
                         ...
                         <form onSubmit = {addUser}>
                                                            ...
                                                            <div className="form-group row">
                                                                <label className="col-sm-2 col-form-label">Username <small>(Optional)</small></label>
                                                                <div className="col-sm-10">
                                                                    <input type="text" 
                                                                    className="form-control"
                                                                    value={username}
                                                            ...
                                                            <div className="form-group row">
                                                                ...
                                                                <div className="col-sm-10">
                                                                    <input type="submit" 
                                                                    value = "Add User" disabled={disAddBtn}
...
className = "bakhtartlink" target="_blank">
    ...
    style={{width: '20px'}} alt = "Heartbeat Gif"/> by Sofien Ressaissi
</span>
<style>
{`\
        .bakhtartlink {\
