...
export default function AllCategories() {
    ...
    useEffect(async() => {
      ...
      const currentCatData = useMemo(() => {
        ...
        return bakhtartCats.slice(firstPageIndex, lastPageIndex);
      }, [currentPage, bakhtartCats]);
...
<head>
    <title>BakhtArt - All Categories</title>
                          ...
                          <ul className="pcoded-item pcoded-left-item">
                              ...
                              <li>
                                  ...
                                  <span className="pcoded-micon"><FaTshirt style={{color: '#021144'}}/></span>
                                      <span className="pcoded-mtext"  data-i18n="nav.basic-components.main"><b>All Categories</b></span>
                                      <span className="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li>
                              ...
                              <div className="row align-items-center">
                                  <div className="col-md-8">
                                      <div className="page-header-title">
                                          ...
                                          <p className="m-b-0">All Categories</p>
                                      </div>
                                  </div>
                                  <div className="col-md-4">
                                      <ul className="breadcrumb-title">
                                          ...
                                          <li className="breadcrumb-item"><a>All Categories</a>
                                          </li>
                                      </ul>
                                  </div>
...
transition: all 0.3s;\
                    ...
                    <div className="card">
                                            ...
                                            <div align = "right">
                                            <input type="text"
                        placeholder="Search Category" className="searchItem"
                                            ...
                                            <div className="card-block table-border-style">
                                                <div className="table-responsive">
                                                    <table className="table table-hover">
                                                        ...
                                                        <tbody>
                                                            {
                                                                currentCatData.filter((item=>{
                                                                    if (searchItem === "") {
                                                                        return item
                                                                    }else if(item.categoryName.toLowerCase().includes(searchItem.toLowerCase())){
                                                                        return item
                                                                    }
                                                                })).reverse().map(itemc => {
                                                                    return(
                                                                    <tr key={itemc._id}>
                                                                    <td>
                                      <img src={`${itemc.categoryImg}`}
                                     alt={`${itemc.imageCatName}`} width="80px" height="40px" style={{marginTop: '-4px'}}/>
                                                                    </td>
                                                                    
                                                                    <td>
                                                                        <a href = {`https://bakhtart.herokuapp.com/bakhtArt/products/${itemc.categoryPath}`}
                                                                        target = "_blank" style={{color: '#3A8EBA'}}>
                                                                        <u>{itemc.categoryName}</u>
                                                                        </a>
                                                                    </td>
                                                                    {/*<td>
                                                                        {
                                                                            itemp.productAddedBy.startsWith(adminbakhtData.adminbakht.firstName) && itemp.productAddedBy.endsWith(adminbakhtData.adminbakht.lastName) ?
        ...
        totalCount={bakhtartCats.length}
        pageSize={PageSize}
