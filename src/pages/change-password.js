                    ...
                    <h5 style={{fontFamily: 'Felix Titling', fontWeight: 'bold'}}>
                        ...
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li className="nav-item">
                                    ...
                                    aria-selected="false" 
                                    style={{fontFamily: 'Felix Titling', color: '#021144'}}>Change My Password</a>
                                </li>
                                <li className="nav-item">
            ...
            <div className="row">
                <div className="col-md-4">
                    ...
                    <p style={{fontFamily: 'Felix Titling'}}>ACCOUNT</p>
                        ...
                        <a href="/account/edit" style = {{color: '#212529',
                        fontFamily: 'Felix Titling'}}>Edit My Account</a><br/>
                            {/*<a href="" style = {{color:'#212529'}}>Security</a><br/>*/}
                            <a href="/account/change-password" style = {{color:'#021144',
                    ...
                    <div id="myTabContent">
                        ...
                        aria-labelledby="home-tab">
                            ...
                            <div className="row" style={{marginTop: '150px;'}}>
                                <div className="col-md-6">
                                    <label style={{fontFamily: 'Felix Titling'}}>Password:
                                    </label>
                                </div>
                                <div className="col-md-6">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <label style={{fontFamily: 'Felix Titling'}}>New Password:
                                    </label>
                                </div>
                                <div className="col-md-6">
                                    <p style = {{color: '#021144'}}>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <label style={{fontFamily: 'Felix Titling'}}>Confirm New Password:
                                    </label>
                                </div>
                                <div className="col-md-6">
                                    <p style = {{color: '#021144'}}>{
                                ...
                                className="btn-primary" value = "Update Password"/>
                            </form>
                        </div>
                    </div>
                </div>
