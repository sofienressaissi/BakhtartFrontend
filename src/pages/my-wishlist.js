...
export default function MyWishlist() {
    ...
    useEffect(async() => {
      ...
      wishProds.map((itemo,index)=>{
        userrData.userr && 
        userrData.userr.id === itemo.userId ? nbWish = nbWish + 1 : <></>
      });

      const currentTableData = useMemo(() => {
        const firstPageIndex = (currentPage - 1) * PageSize;
        const lastPageIndex = firstPageIndex + PageSize;
        return wishProds.slice(firstPageIndex, lastPageIndex);
      }, [currentPage, wishProds]);
      ...
      for (let i = 0; i < currentTableData.length; i++) {
        for (let j = 0; j < bakhtartProds.length; j++) {
            if (currentTableData[i].productId === bakhtartProds[j]._id) {
                wishByLast.push(bakhtartProds[j]);
            }
        }
    }
    ...
    return(
        <>
        {
            ...
            <html>
            <head>
                <title>Bakht'Art - My Wishlist</title>
                        ...
                        <div className="profile-head">
                            ...
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li className="nav-item">
                                    ...
                                    aria-selected="false"
                                    style={{color: '#021144', fontFamily: 'Felix Titling'}}>My Wishlist</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" id="profile-tab" data-toggle="tab"
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="profile-work">
                            ...
                            <a href="/my-wishlist" 
                            style = {{color:'#021144', fontFamily: 'Felix Titling'}}>My Wishlist</a><br/>
...
`}
                                   </style>
                                   {
                                       ...
                                       <div align = "center">
                                       <span style={{fontFamily: 'Felix Titling',
                                    color: '#070C29', fontWeight: 'bold'}}>You have no product in your wishlist</span>
                                       </div> : <></>
                                   }
                                   {
                                       nbWish > 0 ?
                                        ...
                                        <tbody>
                                            {
                                                wishByLast.filter((item=>{
                                                    ...
                                                    currentTableData.map((itemw => (
                                                        itemp._id === itemw.productId
                                                        && userrData.userr
                                                        && userrData.userr.id === itemw.userId ?
                                                        <>
                                                        <tr className="cart_item" key = {itemw.productId}>
                                                            ...
                                                            <td className="product-thumbnail">
                                                                    ...
                                                                    fontFamily: 'Felix Titling', fontWeight: 'bold'}}
                                                                    onClick={() => deleteProdWish(itemw.productId)}>
