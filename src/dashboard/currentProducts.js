...
<head>
    <title>BakhtArt - Current Products</title>
  ...
  <div id="pcoded" className="pcoded">
                          ...
                          <ul className="pcoded-item pcoded-left-item">
                              ...
                              <li>
                                  ...
                                  <span className="pcoded-micon"><FaCheckSquare style={{color: '#021144'}}/></span>
                                      <span className="pcoded-mtext"  data-i18n="nav.basic-components.main"><b>Current Products</b></span>
                                      <span className="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li>
                              ...
                              <div className="row align-items-center">
                                  <div className="col-md-8">
                                      <div className="page-header-title">
                                          ...
                                          <p className="m-b-0">Current Products</p>
                                      </div>
                                  </div>
                                  <div className="col-md-4">
                                      <ul className="breadcrumb-title">
                                          ...
                                          <li className="breadcrumb-item"><a>Current Products</a>
                                          </li>
                                      </ul>
                                  </div>
      ...
      `}
                    ...
                    <div className="card">
                                            ...
                                            <div align = "right">
                                            <input type="text"
                        placeholder="Search Current Product" className="searchItem"
