...
export default function OutOfStockProducts() {
    ...
    const deleteProduct = async (productId) => {
        try {
                await Axios.delete(
                    `https://bakhtart-backend.herokuapp.com/adminbakht/delete-prod/${productId}`
                );
...
<head>
    <title>BakhtArt - Out Of Stock Products</title>
  ...
  <div id="pcoded" className="pcoded">
                          ...
                          <ul className="pcoded-item pcoded-left-item">
                              ...
                              <li>
                                  ...
                                  <span className="pcoded-micon"><FaTrash style={{color: '#021144'}}/></span>
                                      <span className="pcoded-mtext"  data-i18n="nav.basic-components.main"><b>Out Of Stock Products</b></span>
                                      <span className="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li>
                              ...
                              <div className="row align-items-center">
                                  <div className="col-md-8">
                                      <div className="page-header-title">
                                          ...
                                          <p className="m-b-0">Out Of Stock Products</p>
                                      </div>
                                  </div>
                                  <div className="col-md-4">
                                      <ul className="breadcrumb-title">
                                          ...
                                          <li className="breadcrumb-item"><a>Out Of Stock Products</a>
                                          </li>
                                      </ul>
                                  </div>
      ...
      `}
                    ...
                    <div className="card">
                                            ...
                                            <div align = "right">
                                            <input type="text"
                        placeholder="Search Out Of Stock Product" className="searchItem"
                   onChange={(e)=>setSearchItem(e.target.value)}/></div>
                                     ...
                                     alt={`${itemp.imageProdName}`} width="40px" height="40px" style={{marginTop: '-4px'}}/>
                                                                    ...
                                                                    <td>{itemp.productName}<br/>{itemp.productDescription}<br/>
                                                                    {
                                                                        itemp.productDescription.includes("Size") && itemp.productDescription.includes(itemp.productSize) ?
                                                                        <>
                                                                        </> : <>
                                                                    ...
                                                                    {
                                                                        itemp.productDescription.includes("Price") && itemp.productDescription.includes(itemp.productPrice)?
                                                                        <>
                                                                    ...
                                                                    {
                                                                        itemp.productDescription.includes("Color") && itemp.productDescription.includes(GetColorName(itemp.productColor))?
                                                                        <>
