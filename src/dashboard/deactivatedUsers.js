...
export default function DashboardHome() {
    ...
    let [nbDeactivated] = useState(0);

    let [disReacBtn, setDisReacBtn] = useState(false);
    ...
    bakhtartUsers.map(itemb => {
        itemb.userState === false ?
        nbDeactivated = nbDeactivated + 1 : <></>
    })
    ...
    const reactivateUser = async (e, id, email) => {
        try {
            e.preventDefault();
            await Axios.put(
                `https://bakhtart-backend.herokuapp.com/adminbakht/reactivate-user/${id}`
            );
            toast.show({title: 'Account Reactivated! Sending Email!',
...
<head>
    <title>BakhtArt - Deactivated Users</title>
                          ...
                          <ul className="pcoded-item pcoded-left-item">
                              ...
                              <li className="pcoded-hasmenu">
                                  <a href="/admin/deactivated-users" className="waves-effect waves-dark">
                                      ...
                                      <span className="pcoded-mtext"  data-i18n="nav.basic-components.main"><b>Deactivated Users</b></span>
                                      <span className="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li className="pcoded-hasmenu">
                              ...
                              <div className="row align-items-center">
                                  <div className="col-md-8">
                                      <div className="page-header-title">
                                          ...
                                          <p className="m-b-0">Deactivated Users</p>
                                      </div>
                                  </div>
                                  <div className="col-md-4">
                                      <ul className="breadcrumb-title">
                                          ...
                                          <li className="breadcrumb-item"><a>Deactivated Users</a>
                                          </li>
                                      </ul>
                                  </div>
                   ...
                   onChange={(e)=>setSearchItem(e.target.value)}/></div>
                                            <div className="card-block table-border-style">
                                                <div className="table-responsive">
                                                {
                                                                nbDeactivated === 0 ?
                                                                <h4>
                                                                    No User is currently deactivated
                                                                </h4> : <></>
                                                            }
                                  ...
                                  alt="User-Profile-Image" width="40px" height="40px" style={{marginTop: '-4px'}}/>
                                     ...
                                     alt="User-Profile-Image" width="40px" height="40px" style={{marginTop: '-4px'}}/>
                                                                    ...
                                                                    <td>{
                                                                            ...
                                                                            {itemb.region},<br/>{itemb.ville} | {itemb.phoneNumber}</>
                                                                        }</td>
